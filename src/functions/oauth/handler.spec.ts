...
describe('when a get request is made', () => {
  it('should redirect to the oauth url with client_id and scope as query params', async () => {
    ...
    expect(response).toMatchObject({
      ...
      headers: {
        Location:
          'https://accounts.google.com/o/oauth2/v2/auth?access_type=offline&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.readonly&response_type=code&client_id=client-id&redirect_uri=http%3A%2F%2Flocalhost%3A4000%2Fdev%2Foauth-callback',
      },
    });
  });
});
